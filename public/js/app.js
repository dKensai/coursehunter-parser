            ...
            success: function(data) {
                ...
                if (data[0] === true) {
                    ...
                    $dt.fadeOut(function() {
                        ...
                        $dt.html(paste_link).end().fadeIn()

                    });

                    $di.fadeOut();

                    $('.jumbotron').find('p:eq(0)').html(data[1]['title']).end()
                        .find('p:eq(1)').html(data[1]['info']).end()
                        .find('p:eq(2)').html(data[1]['samples']);
                    ...
                    $('.jumbotron').find('ul').html(li).end().fadeIn();
